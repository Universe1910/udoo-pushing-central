...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "系统用户", Method: "DELETE", Path: "/user/deleteUser", Description: "Delete 用户"},
		...
		{ApiGroup: "api", Method: "DELETE", Path: "/api/deleteApisByIds", Description: "批量Delete api"},

		{ApiGroup: "角色", Method: "POST", Path: "/authority/copyAuthority", Description: "拷贝角色"},
		{ApiGroup: "角色", Method: "POST", Path: "/authority/createAuthority", Description: "Create 角色"},
		{ApiGroup: "角色", Method: "POST", Path: "/authority/deleteAuthority", Description: "Delete 角色"},
		...
		{ApiGroup: "菜单", Method: "POST", Path: "/menu/deleteBaseMenu", Description: "Delete 菜单"},
		...
		{ApiGroup: "文件上传与下载", Method: "POST", Path: "/fileUploadAndDownload/deleteFile", Description: "Delete 文件"},
		...
		{ApiGroup: "客户", Method: "POST", Path: "/customer/customer", Description: "Create 客户"},
		{ApiGroup: "客户", Method: "DELETE", Path: "/customer/customer", Description: "Delete 客户"},
		...
		{ApiGroup: "代码生成器", Method: "POST", Path: "/autoCode/createPlug", Description: "自动Create 插件包"},
		...
		{ApiGroup: "包（pkg）生成器", Method: "POST", Path: "/autoCode/delPackage", Description: "Delete 包(package)"},
		...
		{ApiGroup: "代码生成器历史", Method: "POST", Path: "/autoCode/getSysHistory", Description: "Search回滚记录"},
		{ApiGroup: "代码生成器历史", Method: "POST", Path: "/autoCode/delSysHistory", Description: "Delete 回滚记录"},
		...
		{ApiGroup: "系统字典详情", Method: "DELETE", Path: "/sysDictionaryDetail/deleteSysDictionaryDetail", Description: "Delete 字典内容"},
		...
		{ApiGroup: "系统字典", Method: "DELETE", Path: "/sysDictionary/deleteSysDictionary", Description: "Delete 字典"},
		...
		{ApiGroup: "操作记录", Method: "DELETE", Path: "/sysOperationRecord/deleteSysOperationRecord", Description: "Delete 操作记录"},
		{ApiGroup: "操作记录", Method: "DELETE", Path: "/sysOperationRecord/deleteSysOperationRecordByIds", Description: "批量Delete 操作历史"},
		...
		{ApiGroup: "按钮权限", Method: "POST", Path: "/authorityBtn/canRemoveAuthorityBtn", Description: "Delete 按钮"},
	}
