...
func (s *AuthorityRouter) InitAuthorityRouter(Router *gin.RouterGroup) {
	...
	{
		authorityRouter.POST("createAuthority", authorityApi.CreateAuthority)   // Create 角色
		authorityRouter.POST("deleteAuthority", authorityApi.DeleteAuthority)   // Delete 角色
