  ...
  <div class="init_page">
    <div class="init_page_panel">
      <div v-if="hello < 2" id="hello" :class="[hello < 1 ? 'slide-in-fwd-top' : 'slide-out-right']" class="hello">
        <div>
          <div class="hello_title">Udoo Pushing Central</div>
          <p class="in-two a-fadeinT">Initialization notice</p>
          <p class="init_p">1.You need a certain Vue and Golang basics</p>
          <p class="init_p">2.Please confirm whether you have read the official documentation</p>
          <p class="init_p">3.Please confirm whether to understand the subsequent configuration process</p>
          <p class="init_p">Note: The development team does not provide free services for the content written in the documentation</p>
          <p class="init_btn">
        ...
        <el-form ref="formRef" :model="form" label-width="100px">
          ...
          <el-form-item label="password">
            <el-input
              ...
              placeholder="Please enter the database password (there is no empty)"
            />
          </el-form-item>
          <el-form-item label="dbName">
            <el-input v-model="form.dbName" placeholder="Database name" />
          </el-form-item>
          <el-form-item>
            <div style="text-align: right">
              <el-button type="primary" @click="onSubmit">Initialize</el-button>
            </div>
          </el-form-item>
        </el-form>
      </div>
...
const onSubmit = async() => {
  const loading = ElLoading.service({
    lock: true,
    text: 'Initialize the database, please wait a moment',
    spinner: 'loading',
