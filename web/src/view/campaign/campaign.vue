  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="Name" prop="name" width="120" />
         <el-table-column align="left" label="Start At" width="180">
            <template #default="scope">{{ formatDate(scope.row.startAt) }}</template>
         </el-table-column>
         <el-table-column align="left" label="End At" width="180">
        ...
        <el-table-column align="left" label="Parent ID" prop="parentID" width="120" />
        <el-table-column align="left" label="Created By" prop="createdBy" width="120" />
        <!-- <el-table-column align="left" label="Trigger ID" prop="triggerId" width="120" />
        <el-table-column align="left" label="Sequence Id" prop="sequenceId" width="120" /> -->
        <el-table-column align="left" label="Action">
            <template #default="scope">
              <el-button type="primary" link icon="edit" size="small" class="table-button" @click="pushToCampaignDetail(scope.row)">Detail</el-button>
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateCampaignFunc(scope.row)">Edit</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="Add new">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="120px">
        ...
        <el-form-item label="Start At:"  prop="startAt" >
          <el-date-picker v-model="formData.startAt" type="date" style="width:100%" placeholder="Start At" :clearable="true"  />
        </el-form-item>
        <el-form-item label="End At:"  prop="endAt" >
          <el-date-picker v-model="formData.endAt" type="date" style="width:100%" placeholder="End At" :clearable="true"  />
        </el-form-item>
...
const pushToCampaignDetail = (row) =>{
  router.push({
    name: 'campaignDetail',
    params: {
      id: row.ID
