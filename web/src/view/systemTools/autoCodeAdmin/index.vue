  ...
  <div>
    <div class="gva-table-box">
      ...
      <el-table :data="tableData">
        ...
        <el-table-column align="left" label="结构体describe" min-width="150" prop="structCNName" />
...
const deleteRow = async(row) => {
  ElMessageBox.confirm('此操作将Delete本历史, 是否继续?', '提示', {
...
const rollbackFunc = async(row, flag) => {
  if (flag) {
    ElMessageBox.confirm(`此操作将Delete自动创建的文件和api（会Delete表！！！）, 是否继续?`, '提示', {
      confirmButtonText: 'Sure',
      cancelButtonText: 'Cancel',
      type: 'warning'
    }).then(async() => {
      ElMessageBox.confirm(`此操作将Delete自动创建的文件和api（会Delete表！！！）, 请继续确认！！！`, '会Delete表', {
        confirmButtonText: 'Sure',
        cancelButtonText: 'Cancel',
        type: 'warning'
      }).then(async() => {
    ...
    ElMessageBox.confirm(`此操作将Delete自动创建的文件和api, 是否继续?`, '提示', {
      confirmButtonText: 'Sure',
      cancelButtonText: 'Cancel',
      type: 'warning'
    }).then(async() => {
